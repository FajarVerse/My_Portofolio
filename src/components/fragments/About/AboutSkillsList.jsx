    ...
    <>
      <div className="w-full">
        ...
        <div className="mt-2 px-2 flex items-center gap-5 flex-wrap md:gap-7 lg:gap-5">
          ...
          >
            <svg
              className="skills-size transition-all duration-300 ease-bounce group-hover:fill-[#777BB4]"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          >
            <svg
              className="skills-size transition-all duration-300 ease-bounce group-hover:fill-[#FF2D20]"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
