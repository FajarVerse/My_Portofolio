    ...
    <>
      <div className="w-full lg:w-1/5">
        ...
        <div className="flex gap-4 px-3 mb-3 lg:px-0 lg:mb-0 lg:flex-col lg:gap-3 lg:w-fit">
          ...
          <SosmedLink
            link="https://wa.me/083894079797"
            username="0838-9407-9797"
            bgColor={`#25D366`}
          >
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
          ...
          <SosmedLink
            link="https://www.instagram.com/fajarverse_62/"
            username="fajarverse_62"
            bgColor="#E4405F"
          >
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
          ...
          <SosmedLink
            link="https://www.linkedin.com/in/gifari-fajar-maulana-449090280/"
            username="Gifari Fajar Maulana"
            bgColor={`#0A66C2`}
          >
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
