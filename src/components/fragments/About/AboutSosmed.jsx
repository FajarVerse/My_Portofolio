    ...
    <>
      <div className="w-full lg:w-1/5">
        ...
        <div className="flex gap-4 px-3 mb-3 lg:px-0 lg:mb-0 lg:flex-col lg:gap-3 lg:w-fit">
          <SosmedLink username="GifariFajar" bgColor={`181717`}>
            <svg
          ...
          <SosmedLink username="0838-9407-9797" bgColor={`25D366`}>
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
              width={19}
              role="img"
          ...
          <SosmedLink username="fajar.3072" bgColor="E4405F">
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
              width={19}
              role="img"
          ...
          <SosmedLink username="" bgColor={`0A66C2`}>
            <svg
              className="fill-current md:w-6 lg:w-6 xl:w-6"
              width={19}
              role="img"
