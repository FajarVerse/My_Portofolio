    ...
    <>
      ...
      <div className="hidden lg:block lg:absolute lg:top-72 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:z-0 xl:scale-125 xl:top-64 2xl:top-80">
        <span>
          ...
          >
            <path
              className={`${darkMode ? "fill-[#333333]" : "fill-[#f7f7f7f7]"}`}
      ...
      <div
        className={`relative mx-auto w-60 md:w-80 lg:w-[24rem] lg:absolute lg:bottom-0 lg:left-1/2 lg:-translate-x-1/2  xl:w-[27.5rem] ${
          darkMode ? "image-container-dark" : "image-container-light"
        }`}
      >
        <motion.div
